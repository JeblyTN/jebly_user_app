                  ...
                  Container(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          Text("Rate for".tr, style: TextStyle(color: themeChange.getThem() ? AppThemeData.grey400 : AppThemeData.grey500, fontSize: 16, fontFamily: AppThemeData.medium)),
                          Text(
                              ...
                              return Padding(
                                ...
                                child: Row(
                                  children: [
                                    ...
                                    RatingBar.builder(
                                      initialRating:
                                      controller.ratingModel.value.id == null
                                          ? 0.0
